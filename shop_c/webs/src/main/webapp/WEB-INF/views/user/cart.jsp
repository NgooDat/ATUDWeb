...
<body class="u-body u-xl-mode" data-style="shopping-cart-template-1"
	...
	<section class="u-clearfix u-block-90d4-1"
		...
		<c:if test="${empty cartDetails}">
			<jsp:include page="/WEB-INF/views/user/nocart.jsp" />
			<style>
section {
	min-height: 80vh;
	background: #fff;
						...
						<table class="u-table-entity u-block-90d4-12">
							...
							<thead class="u-custom-color-1 u-table-header u-block-90d4-13">
								<tr style="height: 33px;">
									<th
										class="u-border-3 u-border-grey-15 u-table-cell u-block-90d4-14">Tài
										khoản</th>
									<th
										class="center u-border-3 u-border-grey-15 u-table-cell u-block-90d4-12">
										Size</th>
									<th
										class="center u-border-3 u-border-grey-15 u-table-cell u-block-90d4-15">
										Giá</th>
									<th
										class="center u-border-3 u-border-grey-15 u-table-cell u-block-90d4-16">
										Số lượng</th>
									<th
										class="center u-border-3 u-border-grey-15 u-table-cell u-block-90d4-17">
										Số tiền</th>
									...
									<tr id="${detail.cartid}" style="height: 100px;"
										...
										<td id="image${detail.cartid}"
											...
											class="u-cart-remove-item u-icon u-icon-rectangle u-block-90d4-42">
												<c:choose>
													<c:when test="${empty selectIdCarts}">
														<input id="checkbox${detail.cartid}" type="checkbox"
															class="u-checkbox">
													</c:when>
													<c:otherwise>
														<c:set var="isChecked" value="false" />
														<c:forEach var="selectIdCart" items="${selectIdCarts}">
															<c:if test="${selectIdCart == detail.cartid}">
										...
										<td id="delete${detail.cartid}"
											...
											onclick="deleteCart(${detail.cartid})"> <span
					...
					<div class="u-cart-button-container">
						<a href="home.htm"
							...
							class="u-icon u-block-90d4-59"><svg
									...
									data-color="#000000" style="width: 1em; height: 1em;">
									<g>
										<g>
											<path
											...
											<tbody
												...
												<tr style="height: 46px;">
													<td
														...
														Tổng cộng</td>
													<td id="totalPrice"
														class="u-border-1 u-border-grey-15 u-table-cell u-block-90d4-82">
														0 VNĐ</td>
												</tr>
										</table>
									</div>
