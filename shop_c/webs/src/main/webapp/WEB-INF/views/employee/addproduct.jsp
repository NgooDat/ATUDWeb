...
<div style="margin-top: 20px;">
    <button onclick="window.location.href='/shop_c/home.htm'" style="padding: 10px 20px; font-size: 16px; cursor: pointer;">
        Trang chủ
    </button>
</div>
    <div class="form-container">
        <h1>Thêm sản phẩm</h1>
        <form action="/shop_c/employee/addproduct.htm" method="POST">
