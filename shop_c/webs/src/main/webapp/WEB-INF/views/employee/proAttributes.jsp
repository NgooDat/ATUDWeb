...
<body class="u-body u-xl-mode" data-style="shopping-cart-template-1"
	...
	<section id="class1" class="class1 u-clearfix u-block-90d4-1"
					...
					<table class="u-table-entity u-block-90d4-12">
						...
						<thead class="u-custom-color-1 u-table-header u-block-90d4-13">
							<tr style="height: 33px;">
								<th
									class="u-border-3 u-border-grey-15 u-table-cell u-block-90d4-14"
									style="text-align: center">Tên</th>
								<th
									class="center u-border-3 u-border-grey-15 u-table-cell u-block-90d4-12">
									Thao tác</th>
							</tr>
						</thead>
						<tbody
										...
										<tr style="height: 60px;" class="cartProduct">
											...
											<td class="center">
												<button onclick="handleButtonClick(event)" type="submit"
													name="action" value="update" class="save">Cập nhật</button>
												<button onclick="handleButtonClick(event)" type="submit"
													name="action" value="delete" class="del">Xóa</button>
											</td>
										</tr>
									</form>
								</c:forEach>
							...
							<form method="post" action="emprodattribute.htm">
								...
								<tr style="height: 60px;" class="cartProduct">
									<td class="center"><input type="text" name="name" value=""
										placeholder="Nhập tên" class="inputtable"></td>
									<td class="center">
										<button onclick="handleButtonClick(event)" name="action"
											value="add" class="save">Thêm</button>
									</td>
								</tr>
							</form>
						</tbody>
	...
	<section id="class2" class="class2 u-clearfix u-block-90d4-1"
		custom-posts-hash="[T,[T,T],[[[I,T],[I,T],[I,T]],[],[],[]]]"
		data-section-properties="{&quot;margin&quot;:&quot;both&quot;,&quot;stretch&quot;:true}"
		data-id="90d4" data-style="shopping-cart-1" id="sec-dd88">
						...
						<tbody
							...
							<form method="post" action="emprodattribute.htm">
								...
								<tr style="height: 60px;" class="cartProduct">
									...
									<td class="center u-border-1 u-border-grey-15 u-table-cell">
										<button onclick="handleButtonClick(event)" type="submit"
											name="action" value="add" class="add">Thêm</button>
									</td>
								</tr>
							</form>
	...
	<section id="class3" class="class3 u-clearfix u-block-90d4-1"
		custom-posts-hash="[T,[T,T],[[[I,T],[I,T],[I,T]],[],[],[]]]"
		data-section-properties="{&quot;margin&quot;:&quot;both&quot;,&quot;stretch&quot;:true}"
		data-id="90d4" data-style="shopping-cart-1" id="sec-dd88">
	...
	<section id="class4" class=" u-clearfix u-block-90d4-1"
		custom-posts-hash="[T,[T,T],[[[I,T],[I,T],[I,T]],[],[],[]]]"
		data-section-properties="{&quot;margin&quot;:&quot;both&quot;,&quot;stretch&quot;:true}"
		data-id="90d4" data-style="shopping-cart-1" id="sec-dd88">
